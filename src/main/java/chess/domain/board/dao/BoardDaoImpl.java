...
import chess.domain.piece.dao.PieceDaoImpl;
...
public class BoardDaoImpl implements BoardDao {
    ...
    public BoardDaoImpl() {
        this.pieceDaoImpl = new PieceDaoImpl();
        this.connection = DBConnection.getConnection();
    }

    public void save(int gameId, Square square, Piece piece) {
        try {
            int pieceId = pieceDaoImpl.findIdByPiece(piece)
                    .orElseGet(() -> pieceDaoImpl.save(piece));
    ...
    public void saveAll(int gameId, Map<Square, Piece> board) {
        try {
            ...
            for (Map.Entry<Square, Piece> b : board.entrySet()) {
                ...
                int pieceId = pieceDaoImpl.findIdByPiece(b.getValue())
                        .orElseGet(() -> pieceDaoImpl.save(b.getValue()));
    ...
    private Map<Square, Piece> makeResultBoard(ResultSet resultSet) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            Piece piece = pieceDaoImpl.findById(resultSet.getInt("piece_id"));
